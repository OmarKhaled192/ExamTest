...
export default {
  ...
  assets: {
    ...
    'auth/verify-otp/index.html': {size: 44444, hash: 'b7711477eed9a4e40d0b0fc631113bf585ac450c12d3b5ab6d3c59a1d4799b07', text: () => import('./assets-chunks/auth_verify-otp_index_html.mjs').then(m => m.default)},
